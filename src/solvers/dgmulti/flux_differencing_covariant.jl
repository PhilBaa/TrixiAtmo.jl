...
function Trixi.calc_volume_integral!(du, u, mesh::DGMultiMesh,
                               have_nonconservative_terms, equations::AbstractCovariantEquations,
...
@inline function Trixi.local_flux_differencing!(fluxdiff_local, u_local, aux_local, element_index,
    ...
    for dim in 1:2 #TODO: generalize to NDIMS
...
@inline function Trixi.hadamard_sum!(du, A,
                               ...
                               orientation_or_normal_direction, u, aux, equations::AbstractCovariantEquations)
...
@inline function Trixi.hadamard_sum!(du, A,
                               ...
                               orientation::Integer, u, aux, equations::AbstractCovariantEquations)
    row_ids, col_ids = axes(A)
